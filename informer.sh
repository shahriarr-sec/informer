...
for sub in $(cat $host);
do
mkdir -p /root/.gdrive/Recon-Data/$sub /root/.gdrive/Recon-Data/$sub/Subdomains /root/.gdrive/Recon-Data/$sub/ReconData /root/.gdrive/Recon-Data/$sub/ReconData/subjack /root/.gdrive/Recon-Data/$sub/ReconData/paramlist /root/.gdrive/Recon-Data/$sub/ReconData/nuclei /root/.gdrive/Recon-Data/$sub/ReconData/CustomWordlist /root/.gdrive/Recon-Data/$sub/Screenshots /root/.gdrive/Recon-Data/$sub/Meg /root/.gdrive/Recon-Data/$sub/ReconData/gf /root/.gdrive/Recon-Data/$sub/ContentDiscovery
#dnscan
...
for sub in $(cat $host);
do
cat /root/.gdrive/Recon-Data/$sub/ReconData/httpx.txt | feroxbuster --stdin -e -k -r -d 3 -t 10 -L 1 -w $wordlist_cd -a "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36" -o /root/.gdrive/Recon-Data/$sub/ContentDiscovery/fuzzer.txt
done
}
content_discovery
